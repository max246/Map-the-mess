...
describe('Contact', () => {
  ...
  it('displays the email address', () => {
    expect(screen.getByText('max246@gmail.com')).toBeInTheDocument()
  })

  it('has a mailto link for the email', () => {
    const emailLink = screen.getByRole('link', { name: /max246@gmail.com/i })
    expect(emailLink).toHaveAttribute('href', 'mailto:max246@gmail.com')
  })
