    ...
    <div className="max-w-3xl mx-auto px-4 py-12">
      ...
      <div className="bg-amber-50 border border-amber-300 rounded-lg p-4 mb-8">
        <p className="text-amber-900 font-semibold">
          ...
          your own risk. Map the Mess and its operators accept no responsibility or liability for any
          injury, loss, damage, or legal consequence arising from your use of this service.
        </p>
      </div>
      ...
      <div className="space-y-8 text-gray-700 leading-relaxed">
        <section>
          ...
          <p>
            Map the Mess is a community platform for reporting <strong>small-scale litter</strong> that
            is suitable for collection by volunteer litter pickers — for example, scattered cans,
            bottles, wrappers, or small bags of rubbish.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            ...
            vehicles to remove. If you encounter fly-tipping or large-scale dumping, please report it
            directly to your <strong>local council</strong> who have the legal powers and resources to
            deal with it.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            Map the Mess and its operators accept <strong>no responsibility or liability</strong> for
            any injury, harm, loss, or damage sustained by any person who chooses to visit a reported
            location or attempt to collect litter. Volunteering to pick up litter is done entirely at
            your own risk. You should always:
          </p>
          <ul className="list-disc ml-6 mt-2 space-y-1">
            <li>Assess the area for hazards before picking up any litter</li>
            <li>Wear appropriate protective equipment (gloves, high-visibility clothing, sturdy footwear)</li>
        ...
        <section>
          ...
          <p>
            ...
            Map the Mess accepts no responsibility for any trespass or legal consequences arising from
            entering private land without proper authorisation.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            ...
            volunteers shall not be held liable for any direct, indirect, incidental, or consequential
            damages, claims, or legal actions arising from:
          </p>
          <ul className="list-disc ml-6 mt-2 space-y-1">
        ...
        <section>
          ...
          <p>
            ...
            any report. Litter may have already been collected or conditions at the reported location
            may have changed.
          </p>
        </section>
